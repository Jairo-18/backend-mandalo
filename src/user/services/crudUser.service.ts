...
export class CrudUserService {
  ...
  private toListItem(user: User): UserPaginatedListItem {
    return {
      ...
      licenseFrontUrl: user.licenseFrontUrl ?? null,
      licenseBackUrl: user.licenseBackUrl ?? null,
      soatUrl: user.soatUrl ?? null,
      technicalInspectionUrl: user.technicalInspectionUrl ?? null,
