...
/**
 * Migración base única: crea todo el esquema desde cero (auth + catálogos)
 * y siembra el superadmin, departamentos y municipios (DANE).
 */
export class InitSchema1783000000000 implements MigrationInterface {
  name = 'InitSchema1783000000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "organizational" ("id" SERIAL NOT NULL, "legalName" character varying(255) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_organizational_id" PRIMARY KEY ("id"))`,
    );

    await queryRunner.query(
      `CREATE TABLE "roleType" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "code" character varying(50) NOT NULL, "name" character varying(100) NOT NULL, CONSTRAINT "UQ_roleType_code" UNIQUE ("code"), CONSTRAINT "PK_roleType_id" PRIMARY KEY ("id"))`,
    );

    await queryRunner.query(
      `CREATE TABLE "department" ("id" SERIAL NOT NULL, "code" character varying(10) NOT NULL, "name" character varying(150) NOT NULL, CONSTRAINT "UQ_department_code" UNIQUE ("code"), CONSTRAINT "PK_department_id" PRIMARY KEY ("id"))`,
    );

    await queryRunner.query(
      `CREATE TABLE "municipality" ("id" SERIAL NOT NULL, "code" character varying(10) NOT NULL, "name" character varying(150) NOT NULL, "departmentId" integer, CONSTRAINT "UQ_municipality_code" UNIQUE ("code"), CONSTRAINT "PK_municipality_id" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "municipality" ADD CONSTRAINT "FK_municipality_department" FOREIGN KEY ("departmentId") REFERENCES "department"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "accessSessions" ("id" uuid NOT NULL, "accessToken" character varying(2000) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP DEFAULT now(), "deletedAt" TIMESTAMP, "userId" uuid NOT NULL, CONSTRAINT "PK_accessSessions_id" PRIMARY KEY ("id"))`,
    );

    // ---------- Llaves foráneas de user ----------
    await queryRunner.query(
      `ALTER TABLE "user" ADD CONSTRAINT "FK_user_municipality" FOREIGN KEY ("municipalityId") REFERENCES "municipality"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" ADD CONSTRAINT "FK_user_department" FOREIGN KEY ("departmentId") REFERENCES "department"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" ADD CONSTRAINT "FK_user_roleType" FOREIGN KEY ("roleTypeId") REFERENCES "roleType"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "accessSessions" ADD CONSTRAINT "FK_accessSessions_user" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );

    // ---------- Seed superadmin — password: Admin@123 (CAMBIAR EN PRODUCCIÓN) ----------
    await queryRunner.query(
      `INSERT INTO "user" ("email", "password", "fullName", "isEmailVerified") VALUES ('admin@mandalo.com', '$2b$12$NVKeXTLajUsf1QleEhZUheweEBeSXe6m9xqyVXIrHJEpeidnP5pfC', 'Super Admin', true)`,
    );

    // ---------- Seed departamentos (DANE) ----------
    await queryRunner.query(`INSERT INTO "department" ("code", "name") VALUES
      ('05', 'Antioquia'),
      ('08', 'Atlantico'),
      ('11', 'Bogota- D.c.'),
      ('13', 'Bolivar'),
    ...
    // ---------- Seed municipios (DANE), enlazados a su departamento ----------
    await queryRunner.query(`INSERT INTO "municipality" ("code", "name", "departmentId")
      SELECT m.code, m.name, d.id
      FROM (VALUES
      ('05001', 'Medellin', '05'),
      ('05002', 'Abejorral', '05'),
      ('05004', 'Abriaqui', '05'),
      ...
      ('99773', 'Cumaribo', '99')
      ) AS m(code, name, dept_code)
      JOIN "department" d ON d.code = m.dept_code`);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "accessSessions" DROP CONSTRAINT "FK_accessSessions_user"`);
    await queryRunner.query(`ALTER TABLE "user" DROP CONSTRAINT "FK_user_roleType"`);
    await queryRunner.query(`ALTER TABLE "user" DROP CONSTRAINT "FK_user_department"`);
    await queryRunner.query(`ALTER TABLE "user" DROP CONSTRAINT "FK_user_municipality"`);
    await queryRunner.query(`ALTER TABLE "municipality" DROP CONSTRAINT "FK_municipality_department"`);
